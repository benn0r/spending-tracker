...
export const styles = StyleSheet.create({
  ...
  activeDirectionButton: { backgroundColor: colors.accent },
  directionButtonText: { color: colors.muted, fontSize: 13, fontWeight: '700' },
  activeDirectionButtonText: { color: colors.white },
  ...
  moreScreen: { flex: 1, paddingTop: 34, backgroundColor: colors.canvas },
  moreDetailPage: { flex: 1, backgroundColor: colors.canvas },
  moreMenu: { paddingHorizontal: 22, paddingTop: 10 },
  moreMenuItem: {
    minHeight: 70,
    flexDirection: 'row',
    alignItems: 'center',
  ...
  sharedExpensesScreen: { flex: 1, paddingTop: 34, backgroundColor: colors.canvas },
